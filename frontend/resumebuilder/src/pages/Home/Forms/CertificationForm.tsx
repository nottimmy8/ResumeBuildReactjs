...
interface certificationProps {
  certificationInfo: { title: string; issuer: string; year: string }[];
  updateArrayItem: (
    index: number,
    field: keyof certificationProps["certificationInfo"][number],
    value: string
  ) => void;
  addArrayItem: (item: certificationProps["certificationInfo"][number]) => void;
