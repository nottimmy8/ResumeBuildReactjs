      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        >
          <div className="flex flex-col items-center px-2">
            <div
              className="w-[100px] h-[110px] max-h-[110px] rounded-full flex items-center justify-center"
          ...
          <div className="my-6 mx-6">
            ...
            <div className="mt-5">
              ...
              {resumeData.educationInfo.map(
                (data: ResumeData["educationInfo"][number], index: number) => (
                  <EducationInfo
        ...
        <div className="col-span-8 pt-10 mr-10 pb-5">
          ...
          <div className="mt-4">
            ...
            {resumeData.workExperience.map(
              (data: ResumeData["workExperience"][number], index: number) => (
                <WorkExperience
                  key={`work_${index}`}
          ...
          <div className="mt-4">
            ...
            {resumeData.projects.map(
              (project: ResumeData["projects"][number], index: number) => (
                <ProjectInfo
                  key={`project_${index}`}
                  title={project.title}
          ...
          <div className="mt-4">
            ...
            {resumeData.certification.map(
              (data: ResumeData["certification"][number], index: number) => (
                <CertificationInfo
                  key={`cert_${index}`}
                  title={data.title}
                  issuer={data.issuer}
